...
wget ${Ncamserversh} -O /usr/lib/enigma2/python/Plugins/Extensions/Levi45ArmEmuKeysUpdater/Ncamserver_Updater.sh || echo "Error: Couldn't connect to ${Ncamserversh}"
echo ""
chmod 775 /usr/lib/enigma2/python/Plugins/Extensions/Levi45ArmEmuKeysUpdater/Ncamserver_Updater.sh
echo ""
