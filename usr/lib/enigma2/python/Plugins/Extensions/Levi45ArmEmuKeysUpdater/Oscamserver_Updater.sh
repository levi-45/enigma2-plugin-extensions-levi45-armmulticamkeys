...
wget ${Oscamserversh} -O /usr/lib/enigma2/python/Plugins/Extensions/Levi45ArmEmuKeysUpdater/Oscamserver_Updater.sh || echo "Error: Couldn't connect to ${Oscamserversh}"
echo ""
chmod 775 /usr/lib/enigma2/python/Plugins/Extensions/Levi45ArmEmuKeysUpdater/Oscamserver_Updater.sh
echo ""
