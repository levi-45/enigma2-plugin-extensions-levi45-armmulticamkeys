...
NcamArm="http://vuplus-team.com/addons/ArmMulticam/Ncam_8.8"
echo ""
echo ""
...
wget ${NcamArm} -O /usr/camd/Ncam_8.8 || echo "Error: Couldn't connect to ${NcamArm}"
echo ""
chmod 775 /usr/camd/Ncam_8.8
echo ""
echo ""
echo "******************************************"
