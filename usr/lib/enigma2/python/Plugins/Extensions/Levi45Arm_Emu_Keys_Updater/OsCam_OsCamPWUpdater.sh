...
OscamPowervuArm="http://vuplus-team.com/addons/ArmMulticam/OScamPowervu_11494"
echo ""
echo ""
...
wget ${OscamPowervuArm} -O /usr/camd/OScamPowervu_11494 || echo "Error: Couldn't connect to ${OscamPowervuArm}"
echo ""
chmod 775 /usr/camd/OScamPowervu_11494
echo ""
echo ""
echo "******************************************"
